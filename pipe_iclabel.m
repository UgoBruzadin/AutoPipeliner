function [EEG, acronym] = pipe_iclabel(EEG, commands)
...
%         else
        ...
        catch EEG = pop_par_runica(EEG,'extended',1,'pca',IC,'verbose','off'); %BUG: it looks likes it picks up the wrong binica files. inconsistent error.
        end
